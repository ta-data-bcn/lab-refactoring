...
class MessageManager:
    ...
    def add_message(self):
        ...
        encrypted_msg = ''.join(self.encoder.encode_str(msg))
    ...
    def read_message(self, pos):
        if(len(self.messages) >= (pos)):
            return self.encoder.decode_str(self.messages[pos - 1])
        else:
